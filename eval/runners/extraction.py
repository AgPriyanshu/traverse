...
NUMERIC_FIELDS = [
    ...
    ("roster_f1", "Roster F1"),
    ("roster_named_precision", "Roster precision (protagonist+major+minor)"),
    ("roster_named_recall", "Roster recall (protagonist+major+minor)"),
    ("roster_named_f1", "Roster F1 (protagonist+major+minor)"),
